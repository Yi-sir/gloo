...
#include "sophon/cuda_allreduce_bcube.h"
#include "sophon/cuda_allreduce_halving_doubling.h"
#include "sophon/cuda_allreduce_halving_doubling_pipelined.h"
#include "sophon/cuda_allreduce_ring.h"
#include "sophon/cuda_allreduce_ring_chunked.h"
#include "sophon/test/cuda_base_test.h"
...
using Func = std::unique_ptr<::sophon::Algorithm>(
    std::shared_ptr<::sophon::Context>&,
    std::vector<float*> ptrs,
    int count,
    std::vector<cudaStream_t> streams);

using Func16 = std::unique_ptr<::sophon::Algorithm>(
    std::shared_ptr<::sophon::Context>&,
...
static std::function<Func> allreduceRing =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       int count,
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
...
static std::function<Func16> allreduceRingHP =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceRing<float16>(
...
static std::function<Func> allreduceRingChunked =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceRingChunked<float>(
              context, ptrs, count, streams));
    };
...
static std::function<Func16> allreduceRingChunkedHP =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceRingChunked<float16>(
              context, ptrs, count, streams));
    };
...
static std::function<Func> allreduceHalvingDoubling =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceHalvingDoubling<float>(
              context, ptrs, count, streams));
    };
...
static std::function<Func> allreduceBcube =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceBcube<float>(context, ptrs, count, streams));
    };
...
static std::function<Func16> allreduceHalvingDoublingHP =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceHalvingDoubling<float16>(
              context, ptrs, count, streams));
    };
...
static std::function<Func> allreduceHalvingDoublingPipelined =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceHalvingDoublingPipelined<float>(
              context, ptrs, count, streams));
    };
...
static std::function<Func16> allreduceHalvingDoublingPipelinedHP =
    [](std::shared_ptr<::sophon::Context>& context,
       ...
       std::vector<cudaStream_t> streams) {
      return std::unique_ptr<::sophon::Algorithm>(
          new ::sophon::CudaAllreduceHalvingDoublingPipelined<float16>(
              context, ptrs, count, streams));
    };

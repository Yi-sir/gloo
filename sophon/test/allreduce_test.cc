...
static std::function<Func> allreduceRing =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceRing<float> algorithm(context, dataPtrs, dataSize);
      algorithm.run();
    };
...
static std::function<Func16> allreduceRingHP =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float16*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceRing<float16> algorithm(context, dataPtrs, dataSize);
      algorithm.run();
    };
...
static std::function<Func> allreduceRingChunked =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceRingChunked<float> algorithm(
...
static std::function<Func16> allreduceRingChunkedHP =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float16*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceRingChunked<float16> algorithm(
          context, dataPtrs, dataSize);
      algorithm.run();
    };
...
static std::function<Func> allreduceHalvingDoubling =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceHalvingDoubling<float> algorithm(
          context, dataPtrs, dataSize);
      algorithm.run();
    };
...
static std::function<Func> allreduceBcube =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceBcube<float> algorithm(context, dataPtrs, dataSize);
      algorithm.run();
    };
...
static std::function<Func16> allreduceHalvingDoublingHP =
    [](std::shared_ptr<::sophon::Context> context,
       std::vector<float16*> dataPtrs,
       int dataSize) {
      ::sophon::AllreduceHalvingDoubling<float16> algorithm(
          context, dataPtrs, dataSize);
      algorithm.run();
    };
...
AllreduceOptions::Func getFunction() {
  void (*func)(void*, const void*, const void*, size_t) = &::sophon::sum<T>;

...
SOPHON_SPECIFIC_MAPPINGS = collections.OrderedDict(
    [
        ("cuda_stream", ("hip_stream", API_SOPHON)),
        ("REGISTER_CUDA_OPERATOR", ("REGISTER_HIP_OPERATOR", API_SOPHON)),
        ("CUDA_1D_KERNEL_LOOP", ("HIP_1D_KERNEL_LOOP", API_SOPHON)),
        ("CUDAContext", ("HIPContext", API_SOPHON)),
        ("CAFFE_CUDA_NUM_THREADS", ("CAFFE_HIP_NUM_THREADS", API_SOPHON)),
        ("HasCudaGPU", ("HasHipGPU", API_SOPHON)),
        ("__expf", ("expf", API_SOPHON)),
        ("CUBLAS_ENFORCE", ("ROCBLAS_ENFORCE", API_SOPHON)),
        ("CUBLAS_CHECK", ("ROCBLAS_CHECK", API_SOPHON)),
        ("cublas_handle", ("rocblashandle", API_SOPHON)),
        ("CURAND_ENFORCE", ("HIPRAND_ENFORCE", API_SOPHON)),
        ("CURAND_CHECK", ("HIPRAND_CHECK", API_SOPHON)),
        ("curandGenerateUniform", ("hiprandGenerateUniform", API_SOPHON)),
        ("curand_generator", ("hiprand_generator", API_SOPHON)),
        ("CaffeCudaGetDevice", ("CaffeHipGetDevice", API_SOPHON)),
        ("USE_CUDA", ("USE_ROCM", API_SOPHON)),
        ("CUDA", ("HIP", API_SOPHON)),
        ("Cuda", ("Hip", API_SOPHON)),
        ("cuda_", ("hip_", API_SOPHON)),
        ("_cuda", ("_hip", API_SOPHON)),
        ("cuda::", ("hip::", API_SOPHON)),
        ("CUDNN", ("MIOPEN", API_SOPHON)),
        ("CuDNN", ("MIOPEN", API_SOPHON)),
        ("cudnn", ("miopen", API_SOPHON)),
        ("namespace cuda", ("namespace hip", API_SOPHON)),
        ("sophon/cuda.h", ("sophon/hip.h", API_SOPHON)),
        ("<nccl.h>", ("<rccl/rccl.h>", API_SOPHON)),
        ("SOPHON_USE_NCCL", ("SOPHON_USE_RCCL", API_SOPHON)),
    ]
)
